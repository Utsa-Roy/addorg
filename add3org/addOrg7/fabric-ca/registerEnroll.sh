...
function createorg7 {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:15054 --caname ca-org7 --tls.certfiles "${PWD}/fabric-ca/org7/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:15054 --caname ca-org7 -M "${PWD}/../organizations/peerOrganizations/org7.example.com/peers/peer0.org7.example.com/msp" --csr.hosts peer0.org7.example.com --tls.certfiles "${PWD}/fabric-ca/org7/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:15054 --caname ca-org7 -M "${PWD}/../organizations/peerOrganizations/org7.example.com/peers/peer0.org7.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org7.example.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org7/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:15054 --caname ca-org7 -M "${PWD}/../organizations/peerOrganizations/org7.example.com/users/User1@org7.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org7/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://org7admin:org7adminpw@localhost:15054 --caname ca-org7 -M "${PWD}/../organizations/peerOrganizations/org7.example.com/users/Admin@org7.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org7/tls-cert.pem"
  { set +x; } 2>/dev/null
